...
{
    public partial class FormMain1280 : Form
    {
        ...
        private void FormMain1280_Load(object sender, EventArgs e)
        {
        ...
        private void loadTableGroup()
        {
            try
            {
                ...
                while (dr.Read())
                {
                    ...
                    btnTableGroup.Width = 88;
                    btnTableGroup.Height = 60;
        ...
        private void tblTableChange_Click(object sender, EventArgs e)
        {
            if (invstatus == "Order")
            {
                MessageBox.Show("You can't change after placing order.", "Success Cafe POS", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
            if (invid != "0")
            {
